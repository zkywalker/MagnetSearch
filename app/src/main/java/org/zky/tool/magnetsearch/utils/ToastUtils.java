...
public class ToastUtils {
     ...
     * @param message
     */
    public static void showToastShort(final int message) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(mContext, message, Toast.LENGTH_SHORT).show();
     ...
     * @param message
     */
    public static void showToastLong(final int message) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(mContext, message, Toast.LENGTH_LONG).show();
    ...
    public static void snack(final View view, final String message){
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                Snackbar.make(view, message, Snackbar.LENGTH_LONG).setAction(GetRes.getString(R.string.i_know), new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
