package org.zky.tool.magnetsearch.utils.swipelayout;
...
/**
 * 支持上拉加载操作的swiperefreshlayout
 * http://blog.csdn.net/Get_Zoom/article/details/57400231
 * Created by zhangkun on 2017/3/27.
 */
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private void createProgressView() {
        mCircleView = new CircleImageView(getContext(), CIRCLE_BG_LIGHT,mCircleDiameter/2);

        mCircleViewBottom = new CircleImageView(getContext(),CIRCLE_BG_LIGHT,mCircleDiameter/2);
